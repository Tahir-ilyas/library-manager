...
def add_book(library):
    ...
    genre = input('enter the genre the Book:')
...
def search_library(library):
        ...
        search_term = input(f"enter the {search_by} term").lower()
...
def display_statics(library):
        ...
        print(f"Percentage_read : {percentage_read:.2f}%python")
